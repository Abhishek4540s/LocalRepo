codeunit 50910 RecurrencePlanninglines
{
    trigger OnRun()
    var
    ...
    begin
        ...
        PlanningLines_lRec.SetRange(Type, PlanningLines_lRec.Type::Resource);
    ...
    begin
        Resource_lRec.Get(PlanningLines_lRec."No.");
        if (Resource_lRec."Unit Cost" <> PlanningLines_lRec."Current Cost") then begin
            ...
            NewPlanningLines_lRec.validate("Current Cost", Resource_lRec."Unit Cost");
    ...
    begin
        ...
        if (Resource_lRec."Unit Cost" <> PlanningLines_lRec."Current Cost") then begin
            ...
            PlanningLines_lRec.Validate("Allow modification", true);
            PlanningLines_lRec.validate("Current Cost", Resource_lRec."Unit Cost");
            PlanningLines_lRec.validate("Unit Cost", Resource_lRec."Unit Cost");
            PlanningLines_lRec.validate("Unit Cost (LCY)", Resource_lRec."Unit Cost");
            PlanningLines_lRec.Validate("Unit Price", 0);
            PlanningLines_lRec.Validate("Unit Price (LCY)", 0);
