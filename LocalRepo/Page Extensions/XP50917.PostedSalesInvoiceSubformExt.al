pageextension 50917 PostedSalesInvoiceSubformExt extends "Posted Sales Invoice Subform"
{
    layout
    {
        modify(Type)
    ...
    local procedure CalculateCost(Rec: Record "Sales Invoice Line")
    var
        Saleline_gRec: Record "Sales Invoice Line";
    begin
        EstimatedPrice_gDec := 0;
        EstimatedCost_gDec := 0;
        GrossMargin_gDec := 0;
        ...
        if Counter_gDec = 0 then
            EstimatedPrice_gDec := TotalSalesInvoiceHeader.Amount;
