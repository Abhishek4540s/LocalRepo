pageextension 50923 PostedSalesCreditSubformExt extends "Posted Sales Cr. Memo Subform"
{
    layout
    {
        modify(Type)
    ...
    local procedure CalculateCost(Rec: Record "Sales Cr.Memo Line")
    var
        Saleline_gRec: Record "Sales Cr.Memo Line";
    begin
        EstimatedPrice_gDec := 0;
        EstimatedCost_gDec := 0;
        GrossMargin_gDec := 0;
        ...
        if Counter_gDec = 0 then
            EstimatedPrice_gDec := TotalSalesCrMemoHeader.Amount;
