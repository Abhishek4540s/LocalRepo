page 50964 "Contract Revenue Method HIST"
{
    ApplicationArea = Basic, Suite;
    //Editable = false;
    PageType = List;
    SourceTable = "Contract Revenue Method Hist";
    SaveValues = true;
    InsertAllowed = false;
    ModifyAllowed = false;
    UsageCategory = Lists;
    caption = 'SV Contract Revenue Method HIST';
        ...
        area(Processing)
        {
            action(Import)
            {
                ...
                begin
                    ...
                    ImportSSTFilesCSV_Cdu.ImportContractRevenueHIST();
                end;
            }
        }
    }
